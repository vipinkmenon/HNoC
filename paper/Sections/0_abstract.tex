...
This scheme is very efficient in interconnected networks such as in computer networks, which use generic switches for interconnecting compute nodes.
...
The effect on bandwidth and resource requirement of this architecture is compared with other FPGA-based NoCs for different number of nodes and different network traffic patterns.
\end{abstract}