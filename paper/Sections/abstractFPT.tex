...
In this paper we analyze the implementation of an asynchronous binary tree based NoC implementation, which achieves better bandwidth by varying the clock frequency between the switches as we move higher in the hierarchy. 
